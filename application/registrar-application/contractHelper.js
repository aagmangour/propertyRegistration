...
async function getContractInstance() {
	...
	const fabricUserName = 'REGISTRAR_ADMIN';
	
	// Load connection profile; will be used to locate a gateway; The CCP is converted from YAML to JSON.
	let connectionProfile = yaml.safeLoad(fs.readFileSync('./connection-profile-registrar.yaml', 'utf8'));
	...
	return channel.getContract('regnet', 'org.property-registration-network.regnet-registrar');
}
